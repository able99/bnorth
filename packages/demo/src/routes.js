export default {
  ...
  'dynamic1': ()=>new Promise(resolve=>setTimeout(()=>{resolve({component: require('./pages/router').PageInfo })},3000)),
  'dynamic': ()=>new Promise(resolve=>setTimeout(()=>{resolve({component: require('./pages/router').PageInfo })},3000)),
