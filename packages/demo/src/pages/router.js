  ...
  return (
    <View>
      <Panel main>
        ...
        <List bc-margin-bottom->
          <List.Item title="query" after="{a:'q1'}" onClick={()=>app.router.push('pageinfo', {query:{a:'q1'}})} />
          <List.Item title="state" after="{a:'s1'}" onClick={()=>app.router.push('pageinfo', {state:{a:'s1'}})} />
        </List>
      </Panel>
    </View>
  );
