...
export default function BaseComponent(aprops) {
  ...
  props.classNameBase = {...props.classNameBase};
  ...
  if(props.touchClick) { props.onTouchStart = props.onClick; delete props['onClick']; }
  ...
  props.classNameBaseProps = {...props.classNameBaseProps}
  props.styleBaseProps = {...props.styleBaseProps}
  Object.entries(props).forEach(([k,v])=>{
    if(k.startsWith('bp-')){
      ...
      if(v===false||v===undefined||v===null) return; 
      let name = k.slice(3); 
      props.classNameBaseProps[name+(v===true?'':('-'+v))] = true;
      ...
      if(!name) return;
      Object.assign(props.styleBaseProps, Array.isArray(v)?name(...v):name(v));
    }
  })
