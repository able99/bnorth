...
var appPlugin = exports.appPlugin = {
  ...
  onCreateStore: function onCreateStore(app) {
    ...
    app.actions = (0, _bindActionCreators2.default)(app.actions, app.actionStore.dispatch);
  },
...
var App = function () {
  ...
  (0, _createClass3.default)(App, [{
     ...
     * @method
     */
    value: function getConfigStorage() {
      var configStr = window.localStorage.getItem(this.config.keys.config);
      if (configStr) {
        try {
    ...
    key: 'loadConfigStorage',
    value: function loadConfigStorage() {
      var config = this.getConfigStorage();
    ...
    key: 'saveConfigStorage',
    value: function saveConfigStorage(config) {
        ...
        for (var _iterator2 = this._plugins[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          try {
            ...
            if (handler) {
              ...
              if (event !== 'onLog') (_app2 = app).verbose.apply(_app2, [_title2].concat(args));
