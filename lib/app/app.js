...
var App = function () {
  ...
  (0, _createClass3.default)(App, [{
     ...
     */
    value: function _createRouteComponent(page, container) {
      if (!page) {
        var title = '_createRouteComponent: page can not be null';
        app.error(title);
    ...
    value: function _configRouteProps(route) {
      ...
      return function props(route) {
        return (0, _react.cloneElement)(route, { children: _react2.default.Children.map(route.props.children, function (v, i) {
            ...
            onEnter = route === _reactRouter.Route && function () {
    ...
    value: function _render() {
      ...
      (0, _reactDom.render)(this._createRootComponent(), this._getRootElement());
    }
     ...
     * 获取app 中的页面
     * @method
     * @param {string|number|element} name - 
     * **默认**：获取最后的页面，即当前焦点页面
     * **空字符串，'/'，0**：获取app 根页面
     * **number**：按页面序号获取
    ...
    value: function showMessageOnRootElement(title, message) {
      (0, _reactDom.render)(_react2.default.createElement(this._ErrorComponent, { title: title, error: (typeof message === 'undefined' ? 'undefined' : (0, _typeof3.default)(message)) === 'object' && message.message || String(message) }), this._getRootElement());
    }
