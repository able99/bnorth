...
function routeOnEnter(originOnEnter, nextState, replace, callback) {
  var ret = app.trigger('onNavigating', nextState);
...
function routeProps(route, config, app) {
  ...
  return function props(route) {
    return (0, _react.cloneElement)(route, { children: _react2.default.Children.map(route.props.children, function (v, i) {
        ...
        onEnter = route === _reactRouter.Route ? routeOnEnter.bind(null, originOnEnter) : null;
    ...
    return function (next) {
      return function (action) {
        if (typeof action === 'function') {
          app.verbose('action func:', action.fname || action.name || 'no name');
...
var appPlugin = exports.appPlugin = {
  ...
  onCreateStore: function onCreateStore(app) {
    ...
    Object.entries(app.actions).forEach(function (_ref2) {
...
var App = function () {
  ...
  (0, _createClass3.default)(App, [{
    ...
    value: function showMessageOnRootElement(title, message) {
      (0, _reactDom.render)(_react2.default.createElement(this.ErrorComponent, { title: title, error: (typeof message === 'undefined' ? 'undefined' : (0, _typeof3.default)(message)) === 'object' && message.message || String(message) }), this.getRootElement());
    }
      ...
      try {
        for (var _iterator3 = (this.pages || [])[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          ...
          try {
            ...
            if (!_v2.props.container || !_v2.props.container.handlers) continue;
    ...
    value: function () {
      var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        var _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, event, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _v3, title;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 61:
                ...
                this.error(title, _context.t3);
                this.errorRender(title, _context.t3);
