...
var BaseContainer = exports.BaseContainer = function () {
  (0, _createClass3.default)(BaseContainer, null, [{
     ...
     * @callback cb
     */
    value: function instance(app, props, containerCreator, cb) {
      var key = 'ck';
...
BaseContainer.maps = {};
function containerConnect(app, containerCreator) {
  ...
  var mapState = function mapState(state, props) {
    var container = BaseContainer.instance(app, props, containerCreator, function (container) {
  ...
  var mapDispatch = function mapDispatch(dispatch, props) {
    var container = BaseContainer.instance(app, props, containerCreator);
    ...
    return {
      ...
      onStop: function onStop(page) {
        ...
        Object.entries(container.states || {}).forEach(function (_ref15) {
