...
var ActionStateData = function (_BaseActionState) {
  (0, _inherits3.default)(ActionStateData, _BaseActionState);
...
exports.default = {
  ...
  init: function init(app) {
    app.actionStates.data = function (options, uuid) {
      return _BaseActionState3.default.instance(ActionStateData, app, uuid, options);
    };
  },
