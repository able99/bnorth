...
var _BaseActionState2 = require('../app/BaseActionState');

var _BaseActionState3 = _interopRequireDefault(_BaseActionState2);
...
var ActionStateRequest = function (_BaseActionState) {
  (0, _inherits3.default)(ActionStateRequest, _BaseActionState);
...
exports.default = {
  ...
  init: function init(app) {
    app.actionStates.request = function () {
      ...
      return _BaseActionState3.default.instance(ActionStateRequest, app, uuid, options);
    };
  },
