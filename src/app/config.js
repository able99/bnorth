 ...
 * @default 网页的当前地址
 */
config.network.baseUrl = window.location.protocol + "//" + window.location.hostname + ((window.location.port === 80 || window.location.port === 443 || window.location.port === "")? "" : ":" + window.location.port) + "/";
/**
 * api的地址，network插件访问地址为，base+api+xxx
 * @property {string} urls.api
 */
config.network.apiUrl = 'api/';
/**
 * 网络请求超时开关与超时时间
 * @property {boolean}
 */
config.network.timeout = 60000;
/**
 * 请求 content type
 * @property {boolean}
 */
config.network.contentType = "application/json";
/**
 * 是否开启网络缓存
 * @property {boolean}
 */
config.network.cache = false;
...
/**
 * @property {ActionStateRequestOptions|NetworkOptions} login.infoOptions
 */
config.login.infoOptions = {};
/**
 * @property {ActionStateRequestOptions|NetworkOptions} login.loginOptions
 */
config.login.loginOptions = {};
/**
 * @property {ActionStateRequestOptions|NetworkOptions} login.logoutOptions
 */
config.login.logoutOptions = {};
/**
